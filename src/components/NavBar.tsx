...
function NavBar(props: NavBarProps) {
  ...
  return (
    <div className={"font-bold text-xl text-stone-600 w-full min-h-[70px] bottom-0 bg-[#f5ef76] shadow-lg px-10 py-2 flex justify-end items-center gap-x-10 flex-wrap max-mobile:justify-evenly max-mobile:gap-x-2" + " " + (props.className == null ? "" : props.className)}>
